...
const Fade = React__default['default'].forwardRef((props, ref) => {
    ...
    return (React__default['default'].createElement(reactTransitionGroup.Transition, Object.assign({ appear: true, visible: visibleProp, onEnter: handleEnter, onEntering: handleEntering, onEntered: handleEntered, onExit: handleExit, onExiting: handleExiting, onExited: handleExited, timeout: timeout, ref: handleRef }, other), (state, childProps) => {
        return React__default['default'].cloneElement(children, Object.assign({ style: Object.assign(Object.assign(Object.assign({ opacity: 0, visibility: state === 'exited' && !visibleProp ? 'hidden' : undefined }, styles[state]), style), children.props.style) }, childProps));
    }));
});
